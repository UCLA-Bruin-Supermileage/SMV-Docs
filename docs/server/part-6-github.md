...
# Hosting Information
The SMV domain is managed through Cloudflare, and can be accessed via the SMV Gmail account. The two static sites, [bruinsmv.com](https://bruinsmv.com) and [info.bruinsmv.com](https://info.bruinsmv.com), are managed through their respective repositories and automatically updated upon pushing to the main branch. All sites under the bruinsmv.com domain are proxied through Cloudflare for security, caching, and DDoS protection. This may result in delayed propagation of changes made to the website.
